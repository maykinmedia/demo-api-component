...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       $ git clone git@github.com:maykinmedia/demo-api-component.git
       $ cd demo-api-component
...
``src/demo_api/conf/local.py``. You can base this file on the
...
.. code-block:: bash
    ...
    $ python src/manage.py test demo_api
...
* ``DB_NAME``: name of the database for the project. Defaults to ``demo_api``.
* ``DB_USER``: username to connect to the database with. Defaults to ``demo_api``.
* ``DB_PASSWORD``: password to use to connect to the database. Defaults to ``demo_api``.
...
1. Clone or download the code from `Github`_ in a folder like
   ...
   .. code-block:: bash
       ...
       $ git clone git@github.com:maykinmedia/demo-api-component.git
       Cloning into 'demo-api-component'...
       ...
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       $ docker-compose up -d
       Starting demoapicomponent_db_1 ... done
       Starting demoapicomponent_web_1 ... done
   ...
   .. code-block:: bash
       ...
       $ docker logs -f demoapicomponent_web_1
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       $ docker exec -it demoapicomponent_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       $ docker exec -it demoapicomponent_web_1 /app/src/manage.py loaddata admin_index groups
...
4. Point your browser to ``http://localhost:8000/`` to access the project's
   ...
   ``http://<ip>:8000/`` instead.

   system you can run ``docker system prune``.

.. _Docker Compose: https://docs.docker.com/compose/install/
.. _Github: https://github.com/maykinmedia/demo_api/
...
environment variables. See ``src/demo_api/conf/docker.py`` for
all settings.
...
.. code-block:: bash
    ...
    $ docker exec -it demo_api /app/src/manage.py createsuperuser
