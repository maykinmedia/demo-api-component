...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'demo_api'),
        'USER': os.getenv('DB_USER', 'demo_api'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'demo_api'),
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'demo_api.utils.context_processors.settings',
            ],
...
DEFAULT_FROM_EMAIL = 'demo_api@example.com'
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    'handlers': {
        ...
        'project': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(LOGGING_DIR, 'demo_api.log'),
            'formatter': 'verbose',
            'maxBytes': 1024 * 1024 * 10,  # 10 MB
            'backupCount': 10
        },
...
AUTHENTICATION_BACKENDS = [
    'demo_api.accounts.backends.UserModelEmailBackend',
    'django.contrib.auth.backends.ModelBackend'
]

SESSION_COOKIE_NAME = 'demo_api_sessionid'
